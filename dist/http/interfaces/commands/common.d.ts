...
export declare type ICommonRes = ICommonResInProgress | ICommonResDone | ICommonResError;
...
declare type error_code = 'unknownCommand' | 'disabledCommand' | 'missingParameter' | 'invalidParameterName' | 'invalidParameterValue' | 'tooManyParameters' | 'corruptedFile' | 'powerOffSequenceRunning' | 'invalidFileFormat' | 'seviceUnavailable' | 'canceledShooting' | 'canceledConversion' | 'unexpected' | 'notFound';
